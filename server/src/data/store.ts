...
import type {
  AdminUser, Customer, Driver, Affiliate, FleetVehicle, WebsiteVehicle, WebsiteFleetCategory,
  Job, Booking, QuoteResult, EarningEntry, Notification, SupportTicket,
  PricingConfig, CancellationPolicy, SiteSettings, NavigationItem, Promotion, FAQItem,
} from '../types';
...
export const drivers: Driver[] = [
  {
    ...
    documents: [
      { id: 'doc-1a', type: 'driving_licence', label: 'Driving Licence', status: 'approved', expiryDate: '2030-06-14', uploadedAt: '2026-01-12T10:00:00Z' },
      { id: 'doc-1b', type: 'phv_badge', label: 'PHV Badge', status: 'approved', expiryDate: '2027-01-01', uploadedAt: '2026-01-12T10:05:00Z' },
      { id: 'doc-1c', type: 'dbs_check', label: 'DBS Check', status: 'approved', uploadedAt: '2026-01-12T10:10:00Z' },
      { id: 'doc-1d', type: 'insurance', label: 'Insurance Certificate', status: 'approved', expiryDate: '2027-03-31', uploadedAt: '2026-01-12T10:15:00Z' },
    ],
  ...
  },
  {
    ...
    documents: [
      { id: 'doc-2a', type: 'driving_licence', label: 'Driving Licence', status: 'pending', uploadedAt: '2026-05-10T09:00:00Z' },
      { id: 'doc-2b', type: 'phv_badge', label: 'PHV Badge', status: 'pending', uploadedAt: '2026-05-10T09:05:00Z' },
      { id: 'doc-2c', type: 'dbs_check', label: 'DBS Check', status: 'missing' },
      { id: 'doc-2d', type: 'insurance', label: 'Insurance Certificate', status: 'pending', uploadedAt: '2026-05-10T09:10:00Z' },
    ],
    isApproved: false,
...
export const fleetVehicles: FleetVehicle[] = [
  {
    id: 'fv-1',
    make: 'Mercedes-Benz', model: 'E-Class', year: 2023, registration: 'SH23 EXC',
  ...
  {
    id: 'fv-2',
    make: 'Range Rover', model: 'Sport', year: 2022, registration: 'SH22 RRS',
  ...
  {
    id: 'fv-3',
    make: 'Ford', model: 'Transit', year: 2021, registration: 'SH21 MIN',
  ...
  {
    id: 'fv-4',
    make: 'Toyota', model: 'Corolla', year: 2022, registration: 'SH22 TAX',
...
export const websiteVehicles: WebsiteVehicle[] = [
  {
...
export const websiteFleetCategories: WebsiteFleetCategory[] = [
...
export const bookings: Booking[] = [
  {
    ...
    customerId: 'cust-1',
    customer: { fullName: 'James Hartley', phone: '+44 7700 900100', email: 'james@example.com' },
    journey: { pickupPostcode: 'S1 1AB', dropoffPostcode: 'M90 1QX', bookingType: 'scheduled', date: '2026-06-15', time: '09:00', passengers: 2 },
    vehicleCategory: 'prestige',
    estimatedMiles: 38,
    estimatedFare: 220,
    jobId: 'job-1',
  },
  {
    ...
    updatedAt: '2026-06-09T10:00:00Z',
    customerId: 'cust-2',
    customer: { fullName: 'Sarah Patel', phone: '+44 7700 900200', email: 'sarah@example.com' },
    journey: { pickupPostcode: 'S3 7SF', dropoffPostcode: 'LS19 7TU', bookingType: 'scheduled', date: '2026-06-16', time: '14:00', passengers: 16, notes: 'Corporate away day' },
    vehicleCategory: 'minibus',
    estimatedMiles: 42,
    estimatedFare: 480,
    jobId: 'job-2',
  },
  {
    ...
    createdAt: '2026-06-08T11:00:00Z',
    updatedAt: '2026-06-08T11:00:00Z',
    customer: { fullName: 'Thomas Williams', phone: '+44 7700 900300', email: 'thomas@example.com' },
    journey: { pickupPostcode: 'S9 1EP', dropoffPostcode: 'NN12 8TN', bookingType: 'scheduled', date: '2026-06-20', time: '07:30', passengers: 44, notes: 'School trip' },
    vehicleCategory: 'coaches',
    estimatedMiles: 95,
    estimatedFare: 980,
    jobId: 'job-3',
...
export const quotes: QuoteResult[] = [];
...
export const supportTickets: SupportTicket[] = [
  {
    ...
    customer: { name: 'Alice Brown', email: 'alice@example.com', phone: '+44 7700 900500' },
...
export const siteSettings: SiteSettings = {
  ...
  seoDefaults: {
    ...
    description: 'Coach and minibus hire across Sheffield and the UK.',
