...
export default function DriverRegistrationScreen() {
  ...
  const [form, setForm] = useState({
    ...
    nationalInsurance: '', affiliateCode: '',
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await authService.registerDriver({ ...form, driverType });
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        {driverType === 'affiliateDriver' && (
          <>
            ...
            <FormInput
              label="Affiliate Company Code or Email"
              value={form.affiliateCode}
              onChangeText={set('affiliateCode')}
              placeholder="Provided by your affiliate"
              required
            />
          </>
        )}
