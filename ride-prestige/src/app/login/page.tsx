    ...
    >
      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="text-center mb-10">
          ...
          <div
            className="inline-flex w-13 h-13 rounded-2xl items-center justify-center mb-5 w-12 h-12"
            style={{
              background: 'linear-gradient(135deg,#c9a84c,#e8c96d,#a07c30)',
              boxShadow: '0 8px 32px rgba(201,168,76,0.3)',
            }}
          >
            <span style={{ color: BLACK, fontFamily: 'Georgia,serif', fontWeight: 700, fontSize: '14px' }}>RP</span>
          </div>
          <h1
            style={{
