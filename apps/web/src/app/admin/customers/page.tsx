...
export default function AdminCustomersPage() {
  ...
  const load = () => adminApi.get<{ success: boolean; data: Customer[] }>('/api/admin/customers')
  ...
  return (
    <div className="space-y-5 max-w-7xl">
      ...
      <div className="bg-white rounded-2xl divide-y divide-slate-50" style={{ border: '1px solid #f0f0f0' }}>
