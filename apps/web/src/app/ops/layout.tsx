...
const NAV = [
  ...
  { label: 'Network', items: [{ href: '/ops/affiliates', label: 'Affiliates', icon: Building2 }, { href: '/ops/drivers', label: 'Driver Applications', icon: Car }, { href: '/ops/vehicles', label: 'Vehicle Approvals', icon: Truck }, { href: '/ops/customers', label: 'Customers', icon: Users }] },
